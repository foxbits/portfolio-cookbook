...
export default function Home() {
  ...
  return (
    <>
      ...
      <AboutSection info={portfolioData.info} profile={portfolioData.profile} />
      ...
      <EducationSection timeline={portfolioData.education} />
      <PortfolioSection items={portfolioData.projects} />
